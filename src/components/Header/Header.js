  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.header__links}>
        <Link href='/home' className={styles.header__link}>
          Home
        </Link>
        <Link href='/feed' className={styles.header__link}>
          Feed
        </Link>
        <Link href='/communities' className={styles.header__link}>
          Communities
        </Link>
        <Link href='/finder' className={styles.header__link}>
          Finder
        </Link>
      </div>
          ...
          {showSettings && (
            ...
            >
              <Link
                ...
                className={styles.settings_popup__item}
              >
                Profile Settings
              </Link>
              <Link href='/survey' className={styles.settings_popup__item}>
